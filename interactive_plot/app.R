...
df <- read_csv("https://raw.githubusercontent.com/dutta/parabolizR/master/animate_play.R")
...
ui <- fluidPage(theme = shinytheme("cerulean"),
  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Player Plot", h3(textOutput("t1")), plotlyOutput(outputId = "distPlot"), value = 1),
