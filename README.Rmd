...
The following document contains the work for the physics calculations behind the functions.
...
<object data="https://github.com/dutta/parabolizR/blob/master/Physics_of_Ball.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="https://github.com/dutta/parabolizR/blob/master/Physics_of_Ball.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="/Physics_of_Ball.pdf">Download PDF</a>.</p>
    </embed>
</object>
